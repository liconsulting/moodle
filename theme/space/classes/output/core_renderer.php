    ...
    */
            ...
            if ($completion->is_enabled()) {
                ...
                if (get_config('theme_space', 'courseprogressbar') == 1) {
                    ...
                    if (has_capability('report/progress:view',  \context_course::instance($course->id))) {
                        ...
                        $output .= html_writer::link($courseprogress, $progressbar, array('class' => 'rui-course-progressbar text-decoration-none'));
                    } else {
                        $output .= $progressbar;
                    }
                }
    ...
    public function space_mycourses() {
        ...
        foreach ($courses as $course) {
            ...
            if ($displayfilterhiddenchbx == '1' && has_capability('moodle/course:viewhiddencourses', \context_course::instance($course->id))) {
                $ishidden = true;
            } else {
                $ishidden = false;
            }
    ...
    public function displayfilterhidden() {
        ...
        if ($displayfilterhiddenchbx == true &&
